...
export const BotWindow = forwardRef<HTMLDivElement, Props>(
  (
    ...
    console.log(errors)
    return (
      <div className="h-[530px] w-[440px] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden">
        ...
        <div className="flex justify-center ">
          <p className="text-gray-400 text-xs">Powered By MarIA</p>
        </div>
      </div>
    )
  }
