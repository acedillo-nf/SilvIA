  ...
  return (
    <div className="py-5 flex flex-col gap-5 items-start">
      <Section
        ...
        message="Cambia el icono de tu chatbot"
      />
      <UploadButton
        label="Edita la imagen"
        register={register}
        errors={errors}
      />
      {chatBot?.icon ? (
        ...
        <div className="rounded-full cursor-pointer shadow-md w-20 h-20 flex items-center justify-center bg-nblue">
          <BotIcon />
        </div>
      )}
    </div>
