  ...
  return (
    <div className="flex flex-col gap-5 justify-center">
      <div className="flex justify-center">
        <h2 className="text-4xl font-bold mb-5">Reserva una reunión</h2>
      </div>
      <div className="flex gap-10 flex-col sm:flex-row">
        <div className="w-[300px]">
          <h6>Llamada</h6>
          <CardDescription>
            Durante esta llamada queremos conocer mejor tus necesidades y darte la mejor atención para el éxito de tu empresa.
          </CardDescription>
        </div>
        <div>
          <Calendar
