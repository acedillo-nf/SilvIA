    ...
    <main>
      ...
      <section>
        <div className="flex items-center justify-center flex-col mt-[80px] gap-4 ">
          <span className="text-nmarino bg-nblue/20 px-4 py-2 rounded-full text-sm">
            Chatbot con IA
          </span>
          <Image
      ...
      <section className="flex justify-center items-center flex-col gap-4 mt-28">
        <h2 className="text-4xl text-center">Noticias</h2>
        <p className="text-muted-foreground text-center max-w-lg">
          Explora nuestras actualizaciones de IA para tu negocio
        </p>
      </section>
